...
export default function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.firstName && formData.lastName && formData.email && formData.password) {
      ...
      toast.success('Welcome to Decor and Culture! Your account has been created successfully.', {
        position: "top-right",
        autoClose: 3000,
      });
      setFormData({
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <div className="hidden lg:block lg:w-1/2 relative">
          <div 
            ...
            style={{
              backgroundImage: 'url("https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=1000&fit=crop")'
            }}
          ></div>
          <div className="absolute inset-0 bg-primary/10 mix-blend-multiply"></div>
          <div className="absolute bottom-12 left-12 max-w-md">
            <p className="text-white text-3xl font-serif font-bold leading-tight drop-shadow-md">
              Join our community and discover the beauty of cultural home decor.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-[440px] flex flex-col">
            <div className="mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-base">
                Join Decor and Culture community today.
              </p>
            </div>
            ...
            <div className="mt-auto pt-10 text-center">
              <p className="text-slate-600 dark:text-slate-400 text-sm">
                ...
                <Link href="/signin" className="text-primary dark:text-primary/80 font-bold hover:underline ml-1">
                  Sign In
                </Link>
              </p>
            </div>
